...
public class InvalidFirstnameTest extends FreeListingPage{
	
	ExtentReports report = ExtendReport.getReportInstance("InvalidFirstNameTest");

	@Test(groups="Regression Test",dataProvider = "Test Data", dataProviderClass = DataProviderSource.class)
	public void verifyPopUpMessageForFirstname(String companyName,String cityName,String firstName,String lastName,String phoneNum,String landlineNum) throws InterruptedException, IOException {
		...
		submitForm();
			...
			String actualmessage = firstNameError.getText();
			 String expectedmessage = "Please enter valid First name";
			try {
				Assert.assertEquals(actualmessage, expectedmessage);
				System.out.println("System gives pop up message");
				logger.log(Status.PASS, "System gives pop up message");
			} catch (Exception e) {
				e.printStackTrace();
