...
public class InvalidMobNoTest extends FreeListingPage{
	...
	public void verifyPopUpMessageForMobileNumber(String companyName,String cityName,String firstName,String lastName,String phoneNum,String landlineNum) throws InterruptedException, IOException {
		
		ExtentTest logger = report.createTest("Get error message for invalid Mobile number");
		...
		String actualmessage = mobNoError.getText();
		 String expectedmessage = "Mobile can start with 6,7,8 or 9 only";
		try {
